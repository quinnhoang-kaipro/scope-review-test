...
// gulp plugins
// Use Dart Sass (works with modern Node/arm64). The old setup used node-sass, which breaks on Node 24.
...
// For production builds, skip watch mode so `npm run build` exits.
function noopTask(done) {
    done();
}
